...
import org.junit.Before;
im
import edu.osu.cse.mmxi.machine.interpreter.instructions.Instruction.JSR;p
import edu.osu.cse.mmxi.machine.interpreter.instructions.Instruction.JSR
import edu.osu.cse.mmxi.machine.interpreter.instructions.Instruction.LD;R
...
import edu.osu.cse.mmxi.machine.interpreter.instructions.Instruction.RET;;ort org.junit.Test;
...
public class InstructionTest {
    ...
    private final short   maskAnd    = Short.parseSho
    @Before
    public final void setUp() {

    }rt("010100000000000", 2);
    ...
    private final short   maskJsrR   = Short.parse
    /**
     * ADD
     */
    ...
    }kNot    = Short.parseShort("100100000000
    @Test
    ...
    public final void AndTrueTrue2Test() {
        ...
        assertEquals("equal", (short) 0, res.getValue());
    } eclipse was setting all registers to final!
    @Before
    public final void setUp() {
    ...
    public final void AndNotTrueImmTest() {
        ...
        assertEquals("equal", (short) 2, res.g
    /**
    ...
    }lic final void BranchPageLimitSimpleTest() {
        m.getPCRegister().setValue((short) 0);
