...
public class SimpleLoaderTest {
     ...
     * 
     * @Test(expected = IOException.class) public void testDirectoryRead() throws
     * IOException, SimpleLoaderFatalException { SimpleLoader.load("src", m); }
     */
    /*
     * // testing that a file doesnt exist error
     * 
     * @Test(expected = IOException.class) public void testNonexistentRead() throws
     * IOException, SimpleLoaderFatalException { SimpleLoader.load("garbage", m); }
     * 
     * @Test public void testRead() throws IOException, SimpleLoaderFatalException {
     * SimpleLoader.load(dir + "/jSample1.txt", m);
     * 
     * // array of memory locations to verify against final int[] dat = { 0x0004, 0x22B0,
     * 0xE0B7, 0xF022, 0x127F, 0x02B3, 0xF025, 0x0068, 0x0069, 0x0020, 0x0000 };
     * 
     * // test memory was loaded properly for (int i = 0; i < dat.length; i++)
